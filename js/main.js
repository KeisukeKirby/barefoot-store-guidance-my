document.addEventListener('DOMContentLoaded', () => {
  ...
  const msDict = {
    ...
    "Additionally, you can inquire and make purchases through our Facebook and Instagram pages, or shop online via our": "Selain itu, anda boleh membuat pertanyaan dan pembelian melalui halaman Facebook dan Instagram kami, atau membeli-belah dalam talian melalui",
    "and": "dan",
    ".": ".",
...
const zhDict = {
    ...
    "Order & Inquiry": "订购与咨询",
    "Additionally, you can inquire and make purchases through our Facebook and Instagram pages, or shop online via our": "此外，您可以通过我们的 Facebook 和 Instagram 页面进行咨询和购买，或通过我们的",
    ",": "、",
    "and": "和",
    ".": " 在线购物。",
