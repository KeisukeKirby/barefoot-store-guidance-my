document.addEventListener('DOMContentLoaded', () => {
  ...
  const msDict = {
    ...
    "Experience the ultimate connection to the earth with Vibram FiveFingers. Our revolutionary footwear allows your feet to move naturally, awakening sensory feedback and promoting healthier movement. Watch our brand story to discover the true feeling of barefoot freedom.": "Alami sambungan mutlak ke bumi dengan VFF FiveFingers. Kasut revolusioner kami membolehkan kaki anda bergerak secara semula jadi, membangkitkan maklum balas deria dan menggalakkan pergerakan yang lebih sihat. Tonton kisah jenama kami untuk meneroka rasa sebenar kebebasan berkaki ayam.",
